...
public class CustomListMall extends ArrayAdapter<String> implements Filterable {
    private final Activity context;
    private String[] hotel;
    private Integer[] imageId;
    String[] hotel1;
    final Integer[] imageId1;
    public CustomListMall(Activity context, String[] hotel, Integer[] imageId) {
        super(context, R.layout.custom_list_mall, hotel);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.custom_list_mall, null, true);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, MallInfoActivity.class);
                intent.putExtra("key_mall", hotel[position]);

...
public class CustomListMar extends ArrayAdapter<String> {
    private final Activity context;
    private String[] hotel;
    private Integer[] imageId;
    String[] hotel1;
    final Integer[] imageId1;
    public CustomListMar(Activity context, String[] hotel, Integer[] imageId) {
        super(context, R.layout.custom_list_mar, hotel);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.custom_list_mar, null, true);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key_mar", hotel[position]);

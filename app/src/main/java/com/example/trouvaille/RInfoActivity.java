...
public class RInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_info);

        Bundle bundle =getIntent().getExtras();
        title=bundle.getString("key_r");
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                DetailR temp= snapshot.getValue(DetailR.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(RInfoActivity.this, "Failed To load post", Toast.LENGTH_SHORT).show();
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(RInfoActivity.this, "Booking Confirmed", Toast.LENGTH_SHORT).show();
            }
        });
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RInfoActivity.this,More_Details.class));
                finish();
            }
        });
        }

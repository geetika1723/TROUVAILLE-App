...
public class CustomListCaf extends ArrayAdapter<String>  implements Filterable {
    private final Activity context;
    private String[] hotel;
    private Integer[] imageId;
    String[] hotel1;
    final Integer[] imageId1;
    public CustomListCaf(Activity context, String[] hotel, Integer[] imageId) {
        super(context, R.layout.custom_list_caf, hotel);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.custom_list_caf , null, true);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CafInfoActivity.class);
                intent.putExtra("key_caf", hotel[position]);

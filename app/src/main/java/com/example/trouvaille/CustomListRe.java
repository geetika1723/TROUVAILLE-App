...
public class CustomListRe extends ArrayAdapter<String> {
    private final Activity context;
    private String[] hotel;
    private Integer[] imageId;
    String[] hotel1;
    final Integer[] imageId1;
    public CustomListRe(Activity context, String[] hotel, Integer[] imageId) {
        super(context, R.layout.custom_list_re, hotel);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.custom_list_re, null, true);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ReInfoActivity.class);
                intent.putExtra("key_re", hotel[position]);

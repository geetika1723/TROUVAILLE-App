...
public class MallInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        more=findViewById(R.id.btn_mall_more);

        myref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                DetailMall temp= snapshot.getValue(DetailMall.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(MallInfoActivity.this, "Failed To load post", Toast.LENGTH_SHORT).show();
            }
        });
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MallInfoActivity.this,Mall_MoreDetails.class));
                finish();
            }
        });
    }
